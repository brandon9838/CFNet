#/bin/bash
/opt/ohpc/pub/nvidia/cuda/cuda-9.0/bin/nvcc tf_grouping_g.cu -o tf_grouping_g.cu.o -c -O2 -DGOOGLE_CUDA=1 -x cu -Xcompiler -fPIC

# TF1.2
#g++ -std=c++11 tf_grouping.cpp tf_grouping_g.cu.o -o tf_grouping_so.so -shared -fPIC -I =  /home/gg1n1nder/.conda/envs/tensorflow/lib/python3.5/site-packages/tensorflow/include -I /opt/ohpc/pub/nvidia/cuda/cuda-9.0/include -lcudart -L /opt/ohpc/pub/nvidia/cuda/cuda-9.0/lib64/ -O2 -D_GLIBCXX_USE_CXX11_ABI=0
